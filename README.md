...
<p align="center">
  ...
  <img alt="版本" src="https://img.shields.io/badge/版本-0.8.5-4a5580">
...
> ⚠️ 安全说明：插件自带设置页与 Web API（`/api/plugin/selfreply/config` 等）**不提供独立鉴权**，
> 访问控制完全依赖宿主 AstrBot Dashboard 的登录与权限体系。请勿将 AstrBot 的 Web 端口暴露到
> 不受信任的网络；`proactive_inherit_tools`、白名单等安全敏感配置的变更会记录在插件 INFO 日志中，便于事后追溯。
