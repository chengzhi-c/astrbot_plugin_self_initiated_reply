...
function getEls() {
  ...
  els = {
    ...
    decisionTimeoutInput: $("decisionTimeoutInput"),
    decisionPromptInput: $("decisionPromptInput"),
    promptPreview: $("promptPreview"),
    resetPromptBtn: $("resetPromptBtn"),
    minContextInput: $("minContextInput"),
    messageDelayInput: $("messageDelayInput"),
    minSilenceInput: $("minSilenceInput"),
    cooldownInput: $("cooldownInput"),
    visionJudgeEnabledInput: $("visionJudgeEnabledInput"),
    visionMainEnabledInput: $("visionMainEnabledInput"),
    visionSkipStickersInput: $("visionSkipStickersInput"),
    visionMaxImagesInput: $("visionMaxImagesInput"),
    visionImageAgeInput: $("visionImageAgeInput"),
    visionTimeoutInput: $("visionTimeoutInput"),
    proactiveInheritToolsInput: $("proactiveInheritToolsInput"),
